	...
	return []Project{
		{
			...
			ShortDescription: "xiaoOS: a Go + TypeScript portfolio with a procedural city, windowed applications and independently readable project and resume documents.",
			...
			Image:            "/static/images/portfolio-project-preview.jpg",
			...
			LiveURL:          "https://davidx.tech",
			DemoType:         "live",
			DemoURL:          "https://davidx.tech",
			Status:           "active",
			Featured:         true,
		...
		},
		{
			...
			Image:            "/static/images/Kyarafit-preview.jpg",
		...
		},
		{
			...
			Image:            "/static/images/outfai-redesign-preview.jpg",
		...
		},
		{
			...
			Image:            "/static/images/Forgearena-preview.jpg",
